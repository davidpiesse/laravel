    ...
    <div class="row">
        ...
        <div class="col-md-8">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <table class="table table-striped">
                                @foreach($raffle->result as $key => $winner)
                                    <tr>
                                        <td>
                                            <span class="text-secondary text-center">{{\App\Helpers::ordinal($key+1)}} : </span> <span class="text-success text-center lead"> <b>{{$winner}}</b></span>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
            ...
            <div class="well well-lg text-center">
                ...
                It created <b>{{$raffle->winners}}</b> {{str_plural('winner', $raffle->winners)}} between <b>{{$raffle->min}}</b>
                and <b>{{$raffle->max}}</b>
            </div>
